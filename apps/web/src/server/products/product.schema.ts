...
export const createProductSchema = z
  .object({
    name: z
      ...
      .max(20, "Il nome deve essere lungo al massimo 20 caratteri"),
    description: z
      .string()
      .max(200, "La descrizione deve essere lunga al massimo 200 caratteri")
      .nullable(),
    price: z.preprocess(
      (val) => Number(val),
    ...
    discountPrice: z.preprocess(
      ...
      z
        .number()
        .positive("Il prezzo scontato deve essere maggiore di zero")
        .nullable(),
    ),
  })
  .refine(
